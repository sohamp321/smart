...
class Cannedgoods extends StatefulWidget {
  const Cannedgoods({Key? key}) : super(key: key);

  @override
  State<Cannedgoods> createState() => _CannedgoodsState();
}

class _CannedgoodsState extends State<Cannedgoods> {
  final auth =FirebaseAuth.instance;
  final ref=FirebaseDatabase.instance.ref('cannedgoods');
