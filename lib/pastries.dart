...
class Pastries extends StatefulWidget {
  const Pastries({Key? key}) : super(key: key);

  @override
  State<Pastries> createState() => _PastriesState();
}

class _PastriesState extends State<Pastries> {
  final auth =FirebaseAuth.instance;
  final ref=FirebaseDatabase.instance.ref('pastries');
